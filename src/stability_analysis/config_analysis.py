...
OUT_DIR = r"/home/sithints/research/projects/t2w_stability/outputs/stability"
...
bootstrap_config_results = np.load(os.path.join(OUT_DIR, "3bootstrap_config_results.npz"), allow_pickle=True)
